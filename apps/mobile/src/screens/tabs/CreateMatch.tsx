...
import PlayerContextProvider, {
  PlayerContext,
} from '../../contexts/palyers/playerContext';
import {
  Input,
  CheckBox,
  ListItem,
        ...
        <ScrollView>
          ...
          <View style={styles.inline}>
            <View style={styles.inlineItem}>
              <Input
                ...
                onChangeText={(e) => setTeamOneName(e)}
            ...
            <View style={styles.inlineItem}>
              <Input
                disabled={inputDisabled}
                disabledInputStyle={{ opacity: 1 }}
                onChangeText={(e) => setTeamTwoName(e)}
                placeholder="team name"
                value={teamTwoName}
              />
            </View>
          ...
          <View style={styles.inline}>
            <View style={styles.inlineItem}>
              ...
              <Button icon={<Icon name="add" />} onPress={handleTeamOneAdd} />
            </View>
            <View style={{ width: 6 }} />
            <View style={styles.inlineItem}>
              ...
              <Button icon={<Icon name="add" />} onPress={handleTeamTwoAdd} />
            </View>
          </View>
              ...
              <View>
                ...
                <View style={{ display: 'flex', flexDirection: 'row' }}>
                  <View style={{ flexGrow: 3 }}>
                    <Button
                      onPress={() => setBattingTeamOverlay(true)}
          ...
          <Overlay isVisible={battingTeamOverlay}>
            <View style={{ width: 200 }}>
              <View>
                <Button
                  onPress={() => handleBattingTeam(teamOneName)}
                  titleStyle={{ color: '#000' }}
                  title={teamOneName}
                  type="clear"
                />
              ...
              <View>
                <Button
                  onPress={() => handleBattingTeam(teamTwoName)}
                  titleStyle={{ color: '#000' }}
                  title={teamTwoName}
                  type="clear"
                />
          ...
          <View style={{ display: 'flex', flexDirection: 'row' }}>
            ...
            <View style={{ flexGrow: 1 }}>
              <Input
                onChangeText={handleOverInput}
                value={overToPlay}
                placeholder="give over like 5 or 6"
                label="Overs To Play"
              />
            </View>
          </View>
